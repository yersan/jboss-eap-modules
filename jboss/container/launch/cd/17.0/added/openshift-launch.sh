...
# For external projects, always start using the launch script supply by wildfly-cekit-modules
# Once the script has been executed and all the modules have been configured, start_runtime() will be invoked.
